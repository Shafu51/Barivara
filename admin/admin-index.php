...
<body>
 ...
 <div class="container-fluid">
  <ul class="nav nav-pills nav-justified">
    <li class="active" style="background-color: #FFF8DC"><a data-toggle="pill" href="#home">House Lists</a></li>
    ...
    <li style="background-color: #FAFACD"><a data-toggle="pill" href="#menu3">Booked Houses</a></li>
  </ul>
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      <center><h3>House Lists</h3></center>
      <div class="container-fluid">
...
<?php $sql2="SELECT * from property_photo where house_id='$house_id'";
    ...
    <div id="menu3" class="tab-pane fade">
      <center><h3>Booked House</h3></center>
      <div class="container">
        ...
        if(mysqli_num_rows($result1)>0)
      {
       ...
       ?>
        ...
        <?php 
        $sql2="SELECT * from add_property where house_id='$house_id'";
