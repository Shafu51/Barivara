...
if(isset($_SESSION["email"])){
    ...
    if(mysqli_num_rows($query)>0)
    {
      while ($rows=mysqli_fetch_assoc($query)) {
      	...
      	$sql1="UPDATE add_property SET booked=1 WHERE house_id='$house_id'";
      	$query1=mysqli_query($db,$sql1);

      	$sql2="INSERT INTO booking(house_id,tenant_id,cod) VALUES ('$house_id','$tenant_id', 1)";
...
<script>
    ...
    window.location.href = "booked-property.php"
}, 2000);
</script>
<div class="container">
