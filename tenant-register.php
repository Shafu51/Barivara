...
<div class="container">
  ...
  <form method="POST" action="tenant-engine.php" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label for="id_type">Catagory:</label>
    ...
    <div class="form-group">
      <label for="card_photo">Upload your Profile Pic:</label>
      <input type="file" class="form-control" placeholder="Upload profile photo" name="pp"required>
    </div>
    <div class="form-group">
